...
public class BusinessLoginPageActivity extends AppCompatActivity {
        ...
        auth.signInWithEmailAndPassword(email.getText().toString(),password.getText().toString())
                .addOnCompleteListener(task -> {
                    ...
                    if (!task.isSuccessful()){
                        ...
                        database.getReference().child("Organization")
    ...
    private void init(){
        email = findViewById(R.id.et_emailId_bss);
        password = findViewById(R.id.et_passwordId_bss);
        makeAccount = findViewById(R.id.make_account_bs);
        reset = findViewById(R.id.tv_reset_password_bss);
        login = findViewById(R.id.btn_login_bss);
        auth  = FirebaseAuth.getInstance();
        database  = FirebaseDatabase.getInstance();
        google = findViewById(R.id.google_logIn_bs);
